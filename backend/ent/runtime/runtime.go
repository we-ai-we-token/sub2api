...
func init() {
	...
	groupDescImageQualityBilling := groupFields[22].Descriptor()
	...
	groupDescImageUseResponsesAPI := groupFields[48].Descriptor()
	...
	usagelogDescImageQuality := usagelogFields[38].Descriptor()
