...
// ImageQualityBilling applies equality check predicate on the "image_quality_billing" field. It's identical to ImageQualityBillingEQ.
func ImageQualityBilling(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImageQualityBilling, v))
}

// ImagePriceLow applies equality check predicate on the "image_price_low" field. It's identical to ImagePriceLowEQ.
func ImagePriceLow(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImagePriceLow, v))
}

// ImagePriceMedium applies equality check predicate on the "image_price_medium" field. It's identical to ImagePriceMediumEQ.
func ImagePriceMedium(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImagePriceMedium, v))
}

// ImagePriceHigh applies equality check predicate on the "image_price_high" field. It's identical to ImagePriceHighEQ.
func ImagePriceHigh(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImagePriceHigh, v))
}
...
// ImageQualityBillingEQ applies the EQ predicate on the "image_quality_billing" field.
func ImageQualityBillingEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImageQualityBilling, v))
}

// ImageQualityBillingNEQ applies the NEQ predicate on the "image_quality_billing" field.
func ImageQualityBillingNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldImageQualityBilling, v))
}

// ImagePriceLowEQ applies the EQ predicate on the "image_price_low" field.
func ImagePriceLowEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImagePriceLow, v))
}

// ImagePriceLowNEQ applies the NEQ predicate on the "image_price_low" field.
func ImagePriceLowNEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldImagePriceLow, v))
}

// ImagePriceLowIn applies the In predicate on the "image_price_low" field.
func ImagePriceLowIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldImagePriceLow, vs...))
}

// ImagePriceLowNotIn applies the NotIn predicate on the "image_price_low" field.
func ImagePriceLowNotIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldImagePriceLow, vs...))
}

// ImagePriceLowGT applies the GT predicate on the "image_price_low" field.
func ImagePriceLowGT(v float64) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldImagePriceLow, v))
}

// ImagePriceLowGTE applies the GTE predicate on the "image_price_low" field.
func ImagePriceLowGTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldImagePriceLow, v))
}

// ImagePriceLowLT applies the LT predicate on the "image_price_low" field.
func ImagePriceLowLT(v float64) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldImagePriceLow, v))
}

// ImagePriceLowLTE applies the LTE predicate on the "image_price_low" field.
func ImagePriceLowLTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldImagePriceLow, v))
}

// ImagePriceLowIsNil applies the IsNil predicate on the "image_price_low" field.
func ImagePriceLowIsNil() predicate.Group {
	return predicate.Group(sql.FieldIsNull(FieldImagePriceLow))
}

// ImagePriceLowNotNil applies the NotNil predicate on the "image_price_low" field.
func ImagePriceLowNotNil() predicate.Group {
	return predicate.Group(sql.FieldNotNull(FieldImagePriceLow))
}

// ImagePriceMediumEQ applies the EQ predicate on the "image_price_medium" field.
func ImagePriceMediumEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImagePriceMedium, v))
}

// ImagePriceMediumNEQ applies the NEQ predicate on the "image_price_medium" field.
func ImagePriceMediumNEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldImagePriceMedium, v))
}

// ImagePriceMediumIn applies the In predicate on the "image_price_medium" field.
func ImagePriceMediumIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldImagePriceMedium, vs...))
}

// ImagePriceMediumNotIn applies the NotIn predicate on the "image_price_medium" field.
func ImagePriceMediumNotIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldImagePriceMedium, vs...))
}

// ImagePriceMediumGT applies the GT predicate on the "image_price_medium" field.
func ImagePriceMediumGT(v float64) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldImagePriceMedium, v))
}

// ImagePriceMediumGTE applies the GTE predicate on the "image_price_medium" field.
func ImagePriceMediumGTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldImagePriceMedium, v))
}

// ImagePriceMediumLT applies the LT predicate on the "image_price_medium" field.
func ImagePriceMediumLT(v float64) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldImagePriceMedium, v))
}

// ImagePriceMediumLTE applies the LTE predicate on the "image_price_medium" field.
func ImagePriceMediumLTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldImagePriceMedium, v))
}

// ImagePriceMediumIsNil applies the IsNil predicate on the "image_price_medium" field.
func ImagePriceMediumIsNil() predicate.Group {
	return predicate.Group(sql.FieldIsNull(FieldImagePriceMedium))
}

// ImagePriceMediumNotNil applies the NotNil predicate on the "image_price_medium" field.
func ImagePriceMediumNotNil() predicate.Group {
	return predicate.Group(sql.FieldNotNull(FieldImagePriceMedium))
}

// ImagePriceHighEQ applies the EQ predicate on the "image_price_high" field.
func ImagePriceHighEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldImagePriceHigh, v))
}

// ImagePriceHighNEQ applies the NEQ predicate on the "image_price_high" field.
func ImagePriceHighNEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldImagePriceHigh, v))
}

// ImagePriceHighIn applies the In predicate on the "image_price_high" field.
func ImagePriceHighIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldImagePriceHigh, vs...))
}

// ImagePriceHighNotIn applies the NotIn predicate on the "image_price_high" field.
func ImagePriceHighNotIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldImagePriceHigh, vs...))
}

// ImagePriceHighGT applies the GT predicate on the "image_price_high" field.
func ImagePriceHighGT(v float64) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldImagePriceHigh, v))
}

// ImagePriceHighGTE applies the GTE predicate on the "image_price_high" field.
func ImagePriceHighGTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldImagePriceHigh, v))
}

// ImagePriceHighLT applies the LT predicate on the "image_price_high" field.
func ImagePriceHighLT(v float64) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldImagePriceHigh, v))
}

// ImagePriceHighLTE applies the LTE predicate on the "image_price_high" field.
func ImagePriceHighLTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldImagePriceHigh, v))
}

// ImagePriceHighIsNil applies the IsNil predicate on the "image_price_high" field.
func ImagePriceHighIsNil() predicate.Group {
	return predicate.Group(sql.FieldIsNull(FieldImagePriceHigh))
}

// ImagePriceHighNotNil applies the NotNil predicate on the "image_price_high" field.
func ImagePriceHighNotNil() predicate.Group {
	return predicate.Group(sql.FieldNotNull(FieldImagePriceHigh))
}
