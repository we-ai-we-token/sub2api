...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		ImageQualityBilling:             source.ImageQualityBilling,
		ImagePriceLow:                   cloneGroupValuePointer(source.ImagePriceLow),
		ImagePriceMedium:                cloneGroupValuePointer(source.ImagePriceMedium),
		ImagePriceHigh:                  cloneGroupValuePointer(source.ImagePriceHigh),
