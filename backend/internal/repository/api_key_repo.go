	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldImageQualityBilling,
				group.FieldImagePriceLow,
				group.FieldImagePriceMedium,
				...
				group.FieldImageUseResponsesAPI,
				group.FieldImageReturnURL,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		ImageQualityBilling:             g.ImageQualityBilling,
		ImagePriceLow:                   g.ImagePriceLow,
		ImagePriceMedium:                g.ImagePriceMedium,
		ImagePriceHigh:                  g.ImagePriceHigh,
