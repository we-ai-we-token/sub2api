...
const routes: RouteRecordRaw[] = [
  ...
  {
    // 自研旧版模型广场（需登录，含生图档位定价）。官方版占 /model-plaza，
    // 本地自研版迁移至 /model-plaza-legacy 与之共存。
    path: '/model-plaza-legacy',
    name: 'UserModelPlaza',
    ...
    meta: {
      ...
      requiresAdmin: false,
      title: 'Model Plaza',
      titleKey: 'modelPlazaLegacy.title',
      descriptionKey: 'modelPlazaLegacy.description'
    }
  },
  {
    path: '/profile',
