export default {
    ...
    operation: {
      imageReport: {
        ...
        latency: '成功耗时',
        latencyUnit: '秒',
        stageLatency: '分段耗时：上游生成 vs 回传客户端',
        stageLatencyHint: '来自逐请求记录(image_generation_records)，只统计成功请求。上游线高=上游或我们慢；回传线高=客户端下载慢（通常是客户端自身并发过高把带宽瓜分了），与我方无关。',
        requestVolume: '请求量',
        platform: '平台',
        model: '模型',
        group: '分组',
      ...
      imageRecords: {
        title: '生图记录',
        description: '逐请求的生图耗时记录（成功+失败），用于分析瓶颈在上游生成、网关排队还是回传',
        filterPlatform: '平台',
        filterModel: '模型',
        filterStatus: '状态',
        filterTimeRange: '时间范围',
        filterMinTotal: '最小总耗时(ms)',
        all: '全部',
        success: '成功',
        failure: '失败',
        refresh: '刷新',
        ...
        expand: '详情',
        collapse: '收起',
        detailTimings: '分段耗时 (ms)',
        authMs: '认证',
        routingMs: '选号(含等待)',
        imageSlotWaitMs: '生图槽等待',
        userSlotWaitMs: '用户槽等待',
        accountSlotWaitMs: '账号槽等待',
        upstreamMs: '上游(最后一次)',
        responseMs: '回传',
        requestId: '请求 ID',
        upstreamRequestId: '上游请求 ID',
        upstreamError: '上游错误',
        attemptsDetail: '失败的上游尝试',
        attemptTime: '时间',
        attemptAccount: '账号',
        attemptStatus: '上游状态码',
        attemptKind: '类型',
