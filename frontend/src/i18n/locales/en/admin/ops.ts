export default {
    ...
    operation: {
      imageReport: {
        ...
        latencyUnit: 's',
        stageLatency: 'Stage latency: upstream generation vs response write-back',
        stageLatencyHint: 'From per-request records (image_generation_records), successful requests only. A high upstream line means the upstream or we are slow; a high response line means the client downloads slowly (usually its own concurrency splitting its bandwidth), not our problem.',
      ...
      imageRecords: {
        title: 'Image Records',
        description: 'Per-request image generation timing records (success and failure) for bottleneck analysis',
        filterPlatform: 'Platform',
        filterModel: 'Model',
        filterStatus: 'Status',
        filterTimeRange: 'Time range',
        filterMinTotal: 'Min total (ms)',
        all: 'All',
        success: 'Success',
        failure: 'Failure',
        refresh: 'Refresh',
        ...
        expand: 'Detail',
        collapse: 'Collapse',
        detailTimings: 'Segment timings (ms)',
        authMs: 'Auth',
        routingMs: 'Routing (incl. waits)',
        imageSlotWaitMs: 'Image slot wait',
        userSlotWaitMs: 'User slot wait',
        accountSlotWaitMs: 'Account slot wait',
        upstreamMs: 'Upstream (last attempt)',
        responseMs: 'Response write-back',
        requestId: 'Request ID',
        upstreamRequestId: 'Upstream request ID',
        upstreamError: 'Upstream error',
        attemptsDetail: 'Failed upstream attempts',
        attemptTime: 'Time',
